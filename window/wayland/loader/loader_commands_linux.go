...
func waylandCommandMappingsAll(commands *WaylandCommands) []loadutil.CommandMapping {
	return []loadutil.CommandMapping{
		...
		{Target: &commands.DisplayGetFd, Name: "wl_display_get_fd"},
		{Target: &commands.DisplayPrepareRead, Name: "wl_display_prepare_read"},
		{Target: &commands.DisplayReadEvents, Name: "wl_display_read_events"},
		{Target: &commands.DisplayCancelRead, Name: "wl_display_cancel_read"},
